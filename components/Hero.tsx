      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">
            Building Dynamic Web and Mobile Applications that serves thousands
            of users,😎
          </p>
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Micheal Great, a Full-stack software developer.
          </p>
          <div className="flex items-center md:gap-3 gap-6 flex-wrap justify-center mb-10 md:mb-0">
            {socialMedia.map((info) => (
              <a key={info.id} href={info.link} target="_blank">
                <div className="w-auto h-10 p-5 cursor-pointer flex justify-center items-center bg-opacity-75 bg-black-200 rounded-lg border border-black-300">
                  <img
                    className="inline"
                    src={info.img}
                    alt="icons"
